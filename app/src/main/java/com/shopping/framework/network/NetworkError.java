...
import com.shopping.framework.network.networkstate.OnAPIError;
...
public class NetworkError extends Throwable {
    ...
    public NetworkState displayAppErrorMessage() {
        ...
        if(ShoppingApplication.getInstance() != null && ShoppingApplication.getInstance().isInternetConnected()) {
