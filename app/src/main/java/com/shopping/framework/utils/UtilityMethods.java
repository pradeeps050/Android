package com.shopping.framework.utils;
...
//    }
    ...
    public static int dpToPx(final float dp) {
        return (int) (dp * ShoppingApplication.getInstance().getContext().getResources().getDisplayMetrics().density + 0.5f);
    }
    ...
    public static void showConfirmationToastMessage(String content){
        Toast.makeText(ShoppingApplication.getInstance().getContext(), content, Toast.LENGTH_LONG).show();
    }
